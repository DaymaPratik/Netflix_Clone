...
function Authentication() {
  ...
  return (
    ...
    bg-[url('https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/f562aaf4-5dbb-4603-a32b-6ef6c2230136/dh0w8qv-9d8ee6b2-b41a-4681-ab9b-8a227560dc75.jpg/v1/fill/w_1280,h_720,q_75,strp/the_netflix_login_background__canada__2024___by_logofeveryt_dh0w8qv-fullview.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..LOYKSxIDqfPwWHR0SSJ-ugGQ6bECF0yO6Cmc0F26CQs')] ">
        ...
        <nav className="flex items-center py-2 w-full justify-between px-[100px] border-2 border-red-500">
            <div>
                <img src="https://upload.wikimedia.org/wikipedia/commons/7/7a/Logonetflix.png" 
                alt="netflix-logo"className="h-[50px]"/>
            </div>
            <div>
                <button className="bg-red-600 text-white px-2 py-1 text-[20px]">Sign In</button>
            </div>
        </nav>

        <div className="login-signup-container py-[100px] border-2 border-yellow-400 h-fit min-h-[90vh]  flex justify-center items-center">
          {
            alreadyNotLogin
            ?
