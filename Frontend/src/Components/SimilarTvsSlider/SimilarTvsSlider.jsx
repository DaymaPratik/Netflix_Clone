   ...
   >
    {
       similarContentArr?.map((item,idx)=>{
           return(
               ...
               <div key={idx} className='w-[130px] min-[600px]:w-[170px] min-[768px]:w-[200px] min-[1024px]:w-[250px] relative min-[1256px]:w-[320px] overflow-hidden rounded-md '>
...
export default SimilarTvsSlider