...
function  MovieSlider({singleCategory}) {
  ...
  return (
    ...
    >
    <h2 className='bg-black text-white text-[18px] min-[600px]:text-[25px]  font-semibold pl-[10px] min-[600px]:pl-[15px] min-[768px]:pl-[40px] py-2 uppercase'>{singleCategory} MOVIES</h2>
