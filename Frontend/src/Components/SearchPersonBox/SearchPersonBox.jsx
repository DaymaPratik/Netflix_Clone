...
function SearchPersonBox({similarContentArr,contentType}) {
       ...
       similarContentArr?.map((item,idx)=>{
           return(
               ...
               <div key={idx} className='w-[130px] min-[600px]:w-[170px] min-[768px]:w-[200px] min-[1024px]:w-[250px] min-[1256px]:w-[320px] overflow-hidden rounded-md '>
                   <img src={`https://image.tmdb.org/t/p/w500${item.profile_path}`}  className='transition duration-200 ease-in hover:scale-125 hover:opacity-60 text-[#ff0000]' alt="Image Not Available" />   
               </div>
